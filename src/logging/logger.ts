import { FatalError, LoggerStackTraceError } from '../errors';
...
function errorParamsToLogMessage(level: LogLevel, source: string | undefined, params: ErrorParams): LogMessage {
    let message;
    let error;
    let code;
    let details;
...
export class Logger implements LogWriter {
    ...
    shouldLog(level: LogLevel) {
        return this._logWriter?.shouldLog(level) ?? false;
    }
